...
* **Materiality:** Rough-hewn obsidian, polished gold leaf filigree.
* **Somatic Goal:** Immediate safety and thermal grounding.

### 2. THE ARCHIVE (The Chronicler's Study)
* **Visual Anchor:** A deep-shadowed library with floating vellum scrolls.
* **Materiality:** Aged timber, translucent glassmorphism, dark leather.
...
## ⚖️ SOVEREIGN ALIGNMENT FILTERS
The Gallery utilizes **Multiple Choice Palette Arrays** to shift the lighting state of these rooms without reloading assets. 
* **[A] NOIR FILIGREE:** Deepens shadows; highlights gold leaf highlights.
* **[B] LUNAR GLASS:** Softens contrast; introduces silver/cool tones.
* **[C] SOVEREIGN VELLUM:** Warms the environment with amber and timber hues.
* **[D] AMETHYST BRONZE:** Introduces deep purple/surrealist shadows.
...
All architectural designs and environmental anchors are the intellectual property of **The Architect**. Licensed under the **GPL v3**.

---

**"Look into the hearth. See the world you've forged."**
